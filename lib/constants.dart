...
class Constants {
  ...
  // Keys for important data values
  static final String keyStepsAtMidnight = 'stepsAtMidnight';
  static final String keyLastResetDate = 'lastResetDate';
  static final String keyLastTotalSteps = 'lastTotalSteps';
